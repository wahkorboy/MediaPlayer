...
class MusicPlayerActivity : AppCompatActivity(), MenuInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvPass = findViewById(R.id.music_player_tv_pass)
        tvDue = findViewById(R.id.music_player_tv_due)
    ...
    private fun setRunnable() {
        runnable = Runnable {
            ...
            tvPass.text = getMinute(mp.currentPosition)
            tvDue.text = getMinute(mp.duration-mp.currentPosition)
